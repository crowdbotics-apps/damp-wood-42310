"""
Django settings for damp_wood_42310 project.
...
ROOT_URLCONF = 'damp_wood_42310.urls'
...
WSGI_APPLICATION = 'damp_wood_42310.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "damp_wood_42310 API",
    "DESCRIPTION": "API documentation for damp_wood_42310 App",
    "VERSION": "v1",
}
